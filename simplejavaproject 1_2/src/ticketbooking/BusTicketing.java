...
public class BusTicketing extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxDestination.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Destination ", "Jaffna", "Hatton", "Colombo", "Kandy", "Ratnapura", "Badulla" }));
    ...
    private void jButtonTotalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTotalActionPerformed
       ...
       if(jComboBoxDestination.getSelectedItem().equals("Colombo") && jRadioButtonFirstClass1.isSelected()&& 
       ...
       jTextFieldTicketType.setText(null);
        ...
        else if(jComboBoxDestination.getSelectedItem().equals("Colombo") && jRadioButtonEconomy1.isSelected()&& 
                jRadioButtonSingle1.isSelected() && (!(jTextFieldPassenger1.getText()== null) )){
          int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
       ...
       jTextFieldTicketType.setText(null);
        ...
        else if(jComboBoxDestination.getSelectedItem().equals("Colombo") && jRadioButtonFirstClass1.isSelected()&& 
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("Jaffna")&& jRadioButtonEconomy1.isSelected()&& 
               jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) )){
     int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
     
      jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("Jaffna");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("One Way");       
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Galle");
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("Jaffna") && jRadioButtonFirstClass1.isSelected() && 
               jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) ) ){
           int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
      ...
      jTextFieldDate2.setText(jDateChooser.getDate().toString());
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("Kandy") && jRadioButtonEconomy1.isSelected() 
               && jRadioButtonReturn1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) )){
       int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
      
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("Kandy");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("Round Trip");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Galle");
       ...
       jTextFieldTicketType.setText(null);
           ...
           else if(jComboBoxDestination.getSelectedItem().equals("Kandy") && jRadioButtonFirstClass1.isSelected()
                   && jRadioButtonReturn1.isSelected() && (!(jTextFieldPassenger1.getText()== null) )){
          int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
   ...
   if(jComboBoxTime.getSelectedItem().equals("11:30")){
      ...
      int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("Ratnapura")&& jRadioButtonEconomy1.isSelected()
               && jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) )){
       int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
   
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("Ratnapura");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("One Way");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Galle");
       ...
       jTextFieldTicketType.setText(null);
          ...
          else if(jComboBoxDestination.getSelectedItem().equals("Ratnapura") && jRadioButtonFirstClass1.isSelected()
                  && jRadioButtonReturn1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) ) ){
         int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
       ...
       jTextFieldTicketType.setText(null);
          ...
          else if(jComboBoxDestination.getSelectedItem().equals("Badulla")&& jRadioButtonEconomy1.isSelected()
               && jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) )){
      int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
     
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("Badulla");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("One Way");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Galle");
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("Badulla") && jRadioButtonFirstClass1.isSelected()
               && jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) ) ){
         int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
    ...
    public javax.swing.JComboBox<String> jComboBoxDestination;
